...
class Otp(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.phone_image = ImageTk.PhotoImage(file="K:\\Code\\Project\\Advanced_intelligent assistant\\otp1.png")
        self.lbl_img1=Label(self,image=self.phone_image,bg="salmon").place(x=0,y=160,width=520,height=500)

        self.phone_image2 = ImageTk.PhotoImage(file="K:\\Code\\Project\\Advanced_intelligent assistant\\otp2 (1).png")
